  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        // title: Text("Программа для отправки фото!", style: TextStyle(color: Colors.yellow),),
        //iconTheme: IconThemeData(Image.asset('assets/logo.png'))),
        title: Wrap(
          alignment: WrapAlignment.center,
          children: [
            Text(
              'Програмный продукт ООО "DSK Binokor"',
              style: TextStyle(
                  color: Colors.yellow,
                  fontSize: 15,
